        ...
        <Navbar className="bordernav d-none d-sm-flex bn2" dark expand="md">
          ...
          <Collapse isOpen={this.state.isOpen} navbar>
            ...
            <NavItem>
              ...
              <NavItem>
                <NavLink to="/programas" className="nav-link text-dark">
            ...
            <Nav navbar className="ml-auto mt-1">
              <NavItem>
                <a className="mr-2" href="https://www.facebook.com/fm88ayacucho/">
                    ...
                    <img id="whatsapp" className="mr-2" src="assets/images/social-icon/what7.png" alt="logofm88" width={30} height={30}/>
